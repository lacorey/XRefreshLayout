...
import in.srain.cube.views.ptr.footer.XrlFooterHandler;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.e("PtrFrameLayout","--mPagingTouchSlop:"+mPagingTouchSlop);
    }
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 3) {
            ...
            if (mContent == null || mHeaderView == null || mFooterView == null) {
                ...
                if (child1 instanceof PtrUIHandler && child2 instanceof XrlFooterHandler) {
                    mHeaderView = child1;
                    mFooterView = child2;
                    mContent = child3;
                } else {
                    throw new IllegalStateException("First child must be PtrUIHandler,third child must be XrlFooterHandler");
                }
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(mFooterView != null){
            ...
            if (isDebug()) {
                PtrCLog.d(LOG_TAG, "onMeasure footer, width: %s, height: %s", mFooterView.getMeasuredWidth(),mFooterHeight);
            }
        }
    }
    ...
    private void layoutChildren() {
        ...
        if (mFooterView != null) {
            ...
            final int left = paddingLeft + lp.leftMargin;
            //hide the footer
            final int top = paddingTop + getMeasuredHeight() - mFooterView.getMeasuredHeight();
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                PtrCLog.v("Action_move","--mDisableWhenHorizontalMove:"+mDisableWhenHorizontalMove+
                        "  mPreventForHorizontal:"+mPreventForHorizontal);
                ...
                PtrCLog.v("Action_move", "ACTION_MOVE: offsetY:%s, currentPos: %s, moveUp: %s, canMoveUp: %s, moveDown: %s: canMoveDown: %s",
                ...
                PtrCLog.v("Action_move","--(moveup && canMoveUp):"+(moveUp && canMoveUp)+"  moveDown:"+moveDown);
