package com.auxvn.xrefreshlib.header;
...
import com.auxvn.xrefreshlib.XRefreshLayout;
import com.auxvn.xrefreshlib.XrlHeaderHandler;


import java.text.SimpleDateFormat;
import java.util.Date;

public class XrlDefaultHeader extends FrameLayout implements XrlHeaderHandler {
    ...
    public XrlDefaultHeader(Context context) {
        super(context);
        initViews(null);
    }

    public XrlDefaultHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public XrlDefaultHeader(Context context, AttributeSet attrs, int defStyle) {
...
//        }
//        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.xrl_default_header, this);
...
//    }
    ...
    private void crossRotateLineFromTopUnderTouch(XRefreshLayout frame) {
//        if (!frame.isPullToRefresh()) {
//            mTitleTextView.setVisibility(VISIBLE);
...
//        }
    ...
    private void crossRotateLineFromBottomUnderTouch(XRefreshLayout frame) {
        mTitleTextView.setVisibility(VISIBLE);
//        if (frame.isPullToRefresh()) {
//            mTitleTextView.setText(getResources().getString(R.string.cube_ptr_pull_down_to_refresh));
//        } else {
